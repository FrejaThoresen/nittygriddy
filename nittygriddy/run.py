...
def create_subparsers(subparsers):
    ...
    parser_run.add_argument('--read_trackref', action='store_true', default=False, help="Use TrackRefs, only available from ESDs")
    parser_run.add_argument('--make_AOD', action='store_true', default=False, help="Make AODs, only available from ESDs and TrackRefs")
